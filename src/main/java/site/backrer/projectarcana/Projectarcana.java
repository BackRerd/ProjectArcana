package site.backrer.projectarcana;
...
@Mod(Projectarcana.MODID)
public class Projectarcana {

    // Define mod id in a common place for everything to reference
    public static final String MODID = "projectarcana";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public Projectarcana() {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        site.backrer.projectarcana.networking.ModMessages.register();
    }
    ...
    public void onAddReloadListener(net.minecraftforge.event.AddReloadListenerEvent event) {
        event.addListener(new site.backrer.projectarcana.data.AwakeningDataLoader());
        event.addListener(new site.backrer.projectarcana.data.MagicConfigDataLoader());
    }
